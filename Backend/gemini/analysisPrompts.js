const analysisReportPrompt =
  "Make a report or gist of the mental health of the user based on his previous chats. It's length will be 50 to 300 words aprox. Use English language strictly, not even any words of other language. Provide keypoints [Observations, Potential Underlying Issues, Concerns, Recommendations, Overall]. Also you have to generate solution strictly based on the char provided";
const analysisScorePrompt =
  "Rate the menatal health of the user in a scale of 1 to 10 where 10 is best and 1 is worst based on the previous chats from the user. Just reply the number in the scale 1 to 10, no other things. You are strictly forbidden to reply any other thing than a number.";
